...
namespace ThinkEdu_Core_Service.Infrastructure.Common;
...
public class BaseRepository<T> : IBaseRepository<T> where T : class
{
    ...
    public async Task<IEnumerable<T>> GetListSortAsync(string? keySort, string sort, List<string> includes)
    {
        ...
        foreach (var include in includes)
        {
            ...
            if (check != null) searchResults = searchResults.Include(check.Name);
        }
    ...
    private T TrimData(T entity)
    {
        ...
        foreach (var stringProperty in stringProperties)
        {
            ...
            if (currentValue != null) stringProperty.SetValue(entity, currentValue.Trim(), null);
        }
